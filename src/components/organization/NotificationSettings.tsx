...
import { FileText, TrendingUp, Bell, CalendarCheck, Loader2, Clock } from 'lucide-react';
  ...
  const reportConfigs = [
    {
      ...
      description: 'Översikt av pågående projekt, budget vs utfall',
    ...
    },
    {
      ...
      description: 'Status på arbetsordrar och kostnadsuppföljning',
    ...
    },
    {
      ...
      description: 'Kommande underhåll och utgående garantier',
    ...
    },
    {
      ...
      description: 'Årssammanfattning av underhåll',
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Välj vilka automatiska rapporter du vill ta emot. Exportera listor i respektive modul (XLSX).
        </CardDescription>
      </CardHeader>
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-1 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {config.enabled && <Badge>Aktiv</Badge>}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-3 border-t">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updatePreference(`${config.type}_frequency`, value)
                      }
                    >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={config.time}
                      onChange={(e) =>
                        updatePreference(`${config.type}_time`, e.target.value)
                      }
                      className="h-8"
                    />
                  </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                updatePreference('notification_email', e.target.value || null)
              }
