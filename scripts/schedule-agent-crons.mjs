...
const sql = [
  ...
  `SELECT jobid, jobname, schedule FROM cron.job WHERE jobname IN ('risk-suggest-actions-daily','weekly-org-digest-monday','generate-embeddings-quarter-hourly','process-embedding-queue') ORDER BY jobname;`,
].join('\n');
